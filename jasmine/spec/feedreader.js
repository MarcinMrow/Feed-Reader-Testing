...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        it('has at least a single entry element when the function is called and completes its work', function(done) {
        // define variable for entries
        var entriesNumbers = document.querySelector('.feed').getElementsByClassName('entry').length;

            expect(entriesNumbers).toBeGreaterThan(0);
            done();
        });
    });
